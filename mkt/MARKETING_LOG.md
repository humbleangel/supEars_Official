...
## 2026-09-22 03:13 UTC — Prelanding page built + lock-in line filed
- Channel: repo. Owner: (1) newcomer text on the new accounts — lock the founder price before it's gone; (2) fresh prelanding HTML (countdown + 2 questions only), change nothing existing — "go".
- Built NEW `mkt/prelanding-countdown.html` only (black/white, live JS countdown to 2026-10-10, Q1+Q2 verbatim, one notify link, no downloads, roadmap footer). `index.html`, `landing-v1.html`, all else untouched. Lock-in line filed in promo file + TASKS.md (account-bios task). My interpretation: "migration account parts" = newcomer-facing texts on the new accounts/pages.
- Cost: 0. Result: built; no public post yet (page goes live with Pages on push — owner ordered hosting there).

## 2026-09-22 03:16 UTC — Pages check: prelanding URL 404s, needs owner
...
## 2026-09-22 03:18 UTC — Prelanding hero now sells (owner: it's a marketing page)
- Channel: repo + Firefox preview. Owner: sell the app — native-language speech → English/any language + privacy. Hero subline rewritten: "Speak in your native language — supEars writes it in English, or any of 26 languages. In total privacy: your voice never leaves your computer. No account, no cloud, no one listening." Reopened in Firefox.
- Cost: 0. Result: shown; awaiting verdict. No public post.

## 2026-09-22 03:20 UTC — Prelanding one-screen rebuild (owner direction)
- Channel: repo + Firefox preview. Owner: keep emblem, add flag logo huge/blurred/transparent behind, everything on one screen, no scroll, kill dead top space. Rebuilt `mkt/prelanding-countdown.html`: fixed full-bleed `supEarsLogoV3.png` at 10% + 28px blur, emblem front, single 100vh column (sell line, 10/10, compact countdown, CTA, lock line, 2 Q&As side-by-side, footer). Tightened Q&A wording to fit. Scroll allowed only on short/small screens as fallback. Reopened in Firefox.
- Cost: 0. Result: shown; awaiting verdict. No public post.

## 2026-09-22 03:20 UTC — Bg reduced (owner: too much blur, too large)
...
## 2026-09-22 03:31 UTC — Prelanding copy cuts (owner verbatim orders)
...
## 2026-09-22 03:32 UTC — One-line merge (owner verbatim)
...
## 2026-09-22 04:19 UTC — Research: YT frame rates + slideshow policy (owner question)
...
## 2026-09-22 06:05 UTC — Research: which accounts work desktop-only, no phone (owner question)
- Channel: repo (research, 6 web passes). Owner: desktop only, no phone, Google connected — can we create the socials? Answer: YES for 4, MAYBE for 2, NO for 2. GREEN: TikTok (tiktok.com/signup → Continue with Google, no phone at signup), Facebook (email in the "mobile or email" field, email-link confirm, then Page), X (Sign up with Google / email code), Pinterest business (desktop-ONLY signup, Google or email, no phone — NEW bonus channel, needs owner approval to add). YELLOW: Instagram (email path exists but 2026 phone walls common — try, park if blocked), Threads (needs IG first). RED: Telegram + WhatsApp (phone number mandatory — stay parked until a phone exists). Kwai untested, likely phone-walled.
- Cost: 0. Result: answered; awaiting owner go-ahead to walk through creation live. No public post.
